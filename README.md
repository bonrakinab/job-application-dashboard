...
- **Five scheduled discovery workers** through JWT-protected Supabase Edge Functions invoked by pg_cron using Vault-backed credentials: hourly direct ATS, two-hour supplemental and enterprise sources, four-hour expanded remote feeds, and six-hour Y Combinator startup-job discovery. Direct ATS receives a half-hour boost on Tuesdays and September/October weekdays during Toronto business hours.
