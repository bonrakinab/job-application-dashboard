...
export function JobListClient({ jobs }: { jobs: JobWithMatch[] }) {
  ...
  return <>
    <div className="searchbar job-filters">
      ...
      <select className="select" aria-label="Job type" value={jobType} onChange={e=>setJobType(e.target.value as JobTypeFilter)}><option value="all">All job types</option><option value="full-time">Full-time</option><option value="part-time">Part-time</option><option value="contract">Contract / contractual</option><option value="remote">Remote</option><option value="hybrid">Hybrid</option></select>
