...
export default async function DashboardPage() {
  ...
  return <>
    <div className="topbar"><div><div className="eyebrow">Personal job intelligence</div><h1 className="title">Opportunity command center</h1><div className="sub">Discover → filter → rank → prepare → review → apply → learn.</div></div><DiscoverButton/></div>
    ...
    <div className="section-head"><h2>Opportunities</h2><span className="small muted">Hard eligibility blockers override match scores.</span></div>
