...
export default async function DashboardPage() {
  ...
  return <>
    ...
    <div className="section-head"><h2>All opportunities</h2><span className="small muted">Every discovered job remains here. Up to 3,000 stored opportunities are loaded, with pagination below. Hard eligibility blockers override match scores.</span></div>
